...
function Home() {
  return (
    ...
    {/* SECCIÓN DE REDES Y CONTACTO (FOOTER) */}
      <footer id="contacto" className="bg-slate-50 text-slate-900 py-16 px-6 border-t border-slate-200">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-12">
          
          {/* Columna 1: Info Empresa */}
          <div>
            <h3 className="text-xl font-bold mb-4 text-blue-900">KRONOS GPS</h3>
            <p className="text-slate-600 leading-relaxed mb-6">
              Líderes en logística y ubicación satelital en Venezuela. Tecnología de punta para tu seguridad.
            </p>
            {/* ICONOS DE REDES SOCIALES */}
            <div className="flex space-x-4">
              <a href="https://facebook.com/tupagina" target="_blank" className="bg-white p-3 rounded-full shadow-sm hover:text-blue-600 transition border border-slate-200" title="Síguenos en Facebook">
                <span className="text-xl">fb</span> 
              </a>
              <a href="https://instagram.com/tupagina" target="_blank" className="bg-white p-3 rounded-full shadow-sm hover:text-pink-600 transition border border-slate-200" title="Síguenos en Instagram">
                <span className="text-xl">ig</span>
              </a>
              <a href="https://linkedin.com/company/tupagina" target="_blank" className="bg-white p-3 rounded-full shadow-sm hover:text-blue-800 transition border border-slate-200" title="Síguenos en LinkedIn">
          ...
          <div>
            ...
            <p className="text-slate-600 mb-2">📍 Caracas, Venezuela</p>
            <p className="text-slate-600">Av. Principal de las Mercedes, Edif. Kronos.</p>
          </div>

          {/* Columna 3: Contacto Directo */}
          <div>
            <h3 className="text-lg font-bold mb-4">Ventas y Soporte</h3>
            <p className="text-slate-600 mb-1">📞 Central: +58 (212) XXX-XXXX</p>
            <p className="text-slate-600 mb-4">📧 info@kronosgps.com</p>
            <a 
              href="https://wa.me/58XXXXXXXXXX?text=Hola,%20deseo%20más%20información%20sobre%20Kronos%20GPS" 
              className="text-blue-600 font-bold hover:underline text-lg"
            >
              Chatear con un asesor ahora →
            </a>
          </div>
        </div>

        <div className="border-t border-slate-200 mt-16 pt-10 text-center text-slate-400 text-xs tracking-widest uppercase">
          © {new Date().getFullYear()} Kronos GPS CA - Todos los derechos reservados.
        </div>
      </footer>

      {/* 🟢 BOTÓN FLOTANTE DE WHATSAPP 🟢 */}
      <a 
        href="https://wa.me/58XXXXXXXXXX?text=Hola,%20estoy%20viendo%20tu%20página%20web%20y%20quisiera%20una%20cotización" 
        target="_blank"
        className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-2xl hover:bg-green-600 transition-all hover:scale-110 z-[100] flex items-center justify-center border-2 border-white"
